    ...
    def handle_detection(self):
        try:
            ...
            if self.sensor_service.detect_sensor_activation(sensor=self.entry_sensor):
                ...
                while not self.sensor_service.detect_sensor_deactivation(self.entry_sensor):
                    time.sleep(0.5)  # Avoid busy waiting

                if not self.sensor_service.is_active(self.cabin_sensor):
